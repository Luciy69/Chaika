...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/5086cf1b51f3b06f4e1796701bf8.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Паста Карбонара</h3>
            <h1 class="tovarnaz">Паста Карбонара</h1>
