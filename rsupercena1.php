...
<!-- main -->
    <main>
        <div class="main_news">
            <a href="#"><img src="./img/main/news1.png" alt="news1" width="1210" height="620"></a>
        </div>
        ...
        <div class="main_saleproducts">
            ...
            <div class="main_saleproducts-products">
                <a href="./Product/rmain31.php"><img src="./img/main/product1.svg" alt="product"></a>
                <a href="./Product/rmain32.php"><img src="./img/main/product2.svg" alt="product"></a>
                <a href="./Product/rmain33.php"><img src="./img/main/product3.svg" alt="product"></a>
                <a href="./Product/rmain34.php"><img src="./img/main/product4.svg" alt="product"></a>
                <a href="./Product/rmain35.php"><img src="./img/main/product5.svg" alt="product"></a>
