...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/main/vql2nqpt8wmy31wkhek40vrxk1sfx25i.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Milka</h3>
            <h1 class="tovarnaz">Milka</h1>
...
<div class="main_markets">
    ...
    <div class="main_saleproducts-products">
        <a href="#"><img src="./img/main/product6.svg" alt="product"></a>
        <a href="#"><img src="./img/main/product7.svg" alt="product"></a>
        <a href="#"><img src="./img/main/product8.svg" alt="product"></a>
        <a href="#"><img src="./img/main/product9.svg" alt="product"></a>
        <a href="#"><img src="./img/main/product10.svg" alt="product"></a>
