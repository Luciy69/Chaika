...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/1614577385_23-p-luk-na-belom-fone-24.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Лук</h3>
            <h1 class="tovarnaz">Лук</h1>
