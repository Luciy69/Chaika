...
<!-- main -->
    <main>
        <div class="main_news">
            <a href="#"><img src="./img/main/news.png" alt="news" height="450" width="1250"></a>
        ...
        <div class="main_saleproducts">
            <div class="main_saleproducts-name">
                <a href="#"><h3>Cупер цена ></h3></a>
                <br><br><br><br>
            </div>
          
            <div class="main_saleproducts-products">
                <a href="./Product/rmain17.php"><img src="./img/main/saleproduct1.svg" alt="product"></a>
                <a href="./Product/rmain18.php"><img src="./img/main/saleproduct2.svg" alt="product"></a>
                <a href="./Product/rmain19.php"><img src="./img/main/saleproduct3.svg" alt="product"></a>
                <a href="./Product/rmain20.php"><img src="./img/main/saleproduct4.svg" alt="product"></a>
                <a href="./Product/rmain21.php"><img src="./img/main/saleproduct5.svg" alt="product"></a>
            </div>
        </div>
