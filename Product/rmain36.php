...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/639e32b171b9ffc15941d5d36792.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Дорадо Турция</h3>
            <h1 class="tovarnaz">Дорадо Турция</h1>
