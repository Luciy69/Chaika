    ...
    <main>
        ...
        <div class="main_saleproducts">
            <div class="main_saleproducts-name">
                <a href="#"><h3>Молоко, сыр, яйца ></h3></a>
                <br><br><br>
            </div>
         
            <div class="main_saleproducts-products">
                <a href="./Product/rmain27.php"><img src="./img/main/product11.svg" alt="product"></a>
                <a href="./Product/rmain10.php"><img src="./img/main/product12.svg" alt="product"></a>
                <a href="./Product/rmain28.php"><img src="./img/main/product13.svg" alt="product"></a>
                <a href="./Product/rmain29.php"><img src="./img/main/product14.svg" alt="product"></a>
                <a href="./Product/rmain30.php"><img src="./img/main/product15.svg" alt="product"></a>
