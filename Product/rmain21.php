...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/972206932.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Milka молочный шоколад</h3>
            <h1 class="tovarnaz">Milka молочный шоколад</h1>
