...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/328ea7e5f7df57206a7a61725d7f.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Винегрет овощной</h3>
            <h1 class="tovarnaz">Винегрет овощной</h1>
