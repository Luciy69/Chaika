...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/2c4f5db70888dee7511334afc520.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Форель стейк замороженный, 500г</h3>
            <h1 class="tovarnaz">Форель стейк замороженный, 500г</h1>
