...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/bde5f254f1abc3d87b0b70871860.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Салат Сельдь под шубой</h3>
            <h1 class="tovarnaz">Салат Сельдь под шубой</h1>
