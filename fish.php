    ...
    <main>
        ...
        <div class="main_saleproducts">
            ...
            <div class="main_saleproducts-products">
                <a href="./Product/main36.php"><img src="./img/main/main36.svg" alt="product"></a>
                <a href="./Product/main37.php"><img src="./img/main/main37.svg" alt="product"></a>
                <a href="./Product/main38.php"><img src="./img/main/main38.svg" alt="product"></a>
                <a href="./Product/main39.php"><img src="./img/main/main39.svg" alt="product"></a>
                <a href="./Product/main40.php"><img src="./img/main/main40.svg" alt="product"></a>
            </div>
        </div>
        </div>
