...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            <h3 style="padding-left: 15px;color: rgb(54, 104, 4);">Личный кабинет</h3>
            <h3 style="padding-left: 15px;">Заказы</h3>
            <h3 style="padding-left: 15px;">Промокоды</h3>
            <h3 style="padding-left: 15px;">Вы уже покупали</h3>
            <h3 style="padding-left: 15px;">Избранное</h3>
            <h3 style="padding-left: 15px;">Настройки</h3>
        </div>
        <div class="main_saleproducts">
            <h1 class="lich" style="padding-left: 225px;">Личный кабинет</h1>
            <p class="qq1"></p>
    </div>
                <img class="avatar" src="./img/avatar.jpg" alt="avatar" width="180"  height="150">
                <button class="knopka">Загрузить фотографию</button>
                <h3 class="io">ФИО</h3>
