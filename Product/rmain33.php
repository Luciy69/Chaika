...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/202282255-luk-zelenyj.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Зелёный лук упаковка</h3>
            <h1 class="tovarnaz">Зелёный лук упаковка</h1>
