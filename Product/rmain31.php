...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/Bananas_Closeup_White_background_543234_2560x1825.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Бананы</h3>
            <h1 class="tovarnaz">Бананы</h1>
