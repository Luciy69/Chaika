...
<!-- main -->
    <main>
        <div class="main_news">
            <a href="#"><img src="./img/main/news3.png" alt="news3" width="1200" height="580"></a>
        </div>
        ...
        <div class="main_saleproducts">
            ...
            <div class="main_saleproducts-products">
                <a href="./Product/rmain36.php"><img src="./img/main/product16.svg" alt="product"></a>
                <a href="./Product/rmain37.php"><img src="./img/main/product17.svg" alt="product"></a>
                <a href="./Product/rmain38.php"><img src="./img/main/product18.svg" alt="product"></a>
                <a href="./Product/rmain39.php"><img src="./img/main/product19.svg" alt="product"></a>
                <a href="./Product/rmain40.php"><img src="./img/main/product20.svg" alt="product"></a>
            </div>
        </div>
