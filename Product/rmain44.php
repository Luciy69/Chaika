...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/59ed971e08cd20653e49xdd389ff.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Колбаски из говядины Мираторг Чевапчичи, 300г</h3>
            <h1 class="tovarnaz">Колбаски из говядины, 300г</h1>
