...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/050c5f7a9c2cabf8e0c4690cc0c2.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Форель 1.5-2 кг потрошеная Карелия</h3>
            <h1 class="tovarnaz">Форель 1.5-2 кг потрошеная</h1>
