...
<!-- Header -->
    ...
    <div class="header_nav1">
            ...
            <div class="header_nav1-links">
                ...
                <a href="main4.php"><img src="./img/link2.png" alt="link"></a>
...
<br>
      ...
      putForm();
            ...
            try {
                  $conn = new PDO('mysql:host=localhost;dbname=proekt', 'root', 'root');
             //     $dbh = $conn->prepare("select * from users where login = :login and password = :password");
                  ...
                  putForm();
                  echo '<div class="alert alert-primary" role="alert">Нет</div>';
            }}
