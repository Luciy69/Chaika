...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/5866c84f31128c7935a1a3de7093.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Салат Цезарь</h3>
            <h1 class="tovarnaz">Салат Цезарь</h1>
