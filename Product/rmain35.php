...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/kartofel-molli-opisanie-sorta-i-vyrashchivanie.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Картофель</h3>
            <h1 class="tovarnaz">Картофель</h1>
