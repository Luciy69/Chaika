...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/e3cb0361447fd7a6c986201ac3a0.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Салат Оливье</h3>
            <h1 class="tovarnaz">Салат Оливье</h1>
