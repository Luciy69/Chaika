...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/6312163620.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Milka с цельным фундуком</h3>
            <h1 class="tovarnaz">Milka с цельным фундуком</h1>
