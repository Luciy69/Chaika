...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/4ee03135056bf0b1aab337d44xdb.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Тушка цыплёнка на зерновом откорме</h3>
            <h1 class="tovarnaz">Тушка цыплёнка на зерновом откорме</h1>
