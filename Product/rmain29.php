...
<!-- main -->
    <main>
        ...
        <div class="main_categoryproduct">
            ...
            <img src="./img/orig1.png" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
            <h3 class="tovarn">Главная*каталог*Яйцо роксар экстра</h3>
            <h1 class="tovarnaz">Яйцо роксар экстра</h1>
