...
<header>
    <div class="header_nav1">
        ...
        <div class="header_nav1-catalog">
            <p></p>
            <div class="dropdown">
                <button onclick="myFunction()" class="dropbtn" style="background-color: transparent; border: none;">
                    <img src="./img/catalog.png" alt="catalog">Каталог
                </button>
                <div id="myDropdown" class="dropdown-content">
                    <br>
                    <a href="../../rmain5.php">Акции</a>
                    <a href="../../rmain1.php">Скидки</a>
                    <a href="../../rmain6.php">Готовая еда</a>
                    <a href="../../rmain8.php">Молоко, сыр, яйца</a>
                    <a href="../../rmain9.php">Овощи, фрукты, грибы</a>
                    <a href="../../rfish.php">Рыба</a>
                    <a href="../../rbird.php">Мясо и птица</a>
                </div>
            </div>
        </div>
    ...
    <div class="header_nav2">
        <div class="header_nav2-block1">
            <div class="header_nav2-block1--box">
                <a href="../../rmain5.php"><p>Акции</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rmain1.php"><p>Скидки</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rmain6.php"><p>Готовая еда</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rmain8.php"><p>Молоко, сыр, яйца</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rmain9.php"><p>Овощи, фрукты, грибы</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rfish.php"><p>Рыба</p></a>
            </div>
            <div class="header_nav2-block1--box">
                <a href="../../rbird.php"><p>Мясо и птица</p></a>
            </div>
        </div>
    </div>
</header>
...
<main>
    ...
    <div class="main_categoryproduct">
        ...
        <img src="./img/main/1.3.jpg" width="460" height="350" style="border: 1px solid black; margin-left: 15px;">
        <h3 class="tovarn">Главная*каталог*сыр</h3>
        <h1 class="tovarnaz">Cыр</h1>
        ...
        <p class="cub"></p>
        <img class="izbran" src="./img/main/izbr.jpg" width="55" height="45" style="padding-left: 395px; margin: 135px; position: absolute;" onclick="addToFavoritesFromAnotherPage()">
        <p class="nalich">В наличии много</p>
        <p class="samovi">Самовывоз: бесплатно</p>
        <img src="./img/main/unnamed.jpg" width="55" height="45" style="margin: 185px 395px; position: absolute;border: 1px solid black;" onclick="addToCartFromAnotherPage()">
        <p class="cena">329,00₽</p>
    ...
    <div class="main_markets">
        ...
        <div class="main_saleproducts-products">
            <a href="rmain22.php"><img src="./img/main/product6.svg" alt="product"></a>
            <a href="rmain23.php"><img src="./img/main/product7.svg" alt="product"></a>
            <a href="rmain24.php"><img src="./img/main/product8.svg" alt="product"></a>
            <a href="rmain25.php"><img src="./img/main/product9.svg" alt="product"></a>
            <a href="rmain26.php"><img src="./img/main/product10.svg" alt="product"></a>
        </div>
        <br><br><br><br><br><br>
    </div>
</main>
...
function addToCartFromAnotherPage() {
    // Define the product data
    var product = {
        id: 2, // This should be a unique identifier for the product
        name: 'Название товара 2',
        price: 499.00,
        image: './img/main/1.3.jpg'
    };

    // Retrieve the current cart from local storage or create a new one if it doesn't exist
    ...
    function addToFavoritesFromAnotherPage() {
        ...
        // Сохраняем обновленный список в избранное в локальное хранилище
